...
- **Open lo file** -  Display the most recent application log file.
...
- [**Error**](/docs/dev_env/error) - The error panel primarily displays errors where a parameter is missing.
- [**Screens**](/docs/dev_env/screens) - You can find the list of screens, select and manage them.
